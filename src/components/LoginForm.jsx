...
export default function LoginForm({ isModal = false }) {
  ...
  async function handleLogin(e) {
    ...
    if (isModal) {
      // If modal, we can just hard refresh to get global state in sync
  ...
  return (
    <div style={{ display: 'flex', minHeight: isModal ? 'auto' : '100vh', background: '#ffffff', fontFamily: '"Inter", "Segoe UI", sans-serif', width: '100%', height: '100%' }}>
      ...
      <div style={{
        ...
        <div style={{ width: '100%', maxWidth: '440px', margin: '0 auto' }}>
          ...
          {/* Logo */}
          <div style={{ textAlign: isModal ? 'center' : 'left', marginBottom: isModal ? '1.5rem' : '2.5rem' }}>
            <img src="/desayner-logo.png" alt="Desayner" style={{ width: '200px', height: 'auto', display: 'inline-block' }} />
          </div>

          <h1 style={{ fontSize: isModal ? '2rem' : '2.5rem', fontWeight: 800, color: '#0a0a0a', marginBottom: '0.5rem', letterSpacing: '-0.03em', textAlign: isModal ? 'center' : 'left' }}>
            Welcome back !
          </h1>
          <p style={{ fontSize: '0.95rem', color: '#64748b', marginBottom: isModal ? '2rem' : '2.5rem', textAlign: isModal ? 'center' : 'left' }}>
          ...
          <p style={{ textAlign: 'center', marginTop: '2.5rem', fontSize: '0.875rem', color: '#0a0a0a', fontWeight: 500 }}>
            ...
            <Link href="/signup" style={{ color: '#5b45f4', fontWeight: 600, textDecoration: 'underline' }} replace={isModal}>
              Register here
            </Link>
          </p>
        </div>
      ...
      {/* Right Column: Abstract Background (Hidden in modal) */}
      {!isModal && (
        <div style={{
          flex: '1.2',
          display: 'none',
