  ...
  if (success) return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#fafafa', padding: '2rem' }}>
      <div style={{ textAlign: 'center', maxWidth: '400px' }}>
        ...
        <Link href="/login" style={{ padding: '0.9rem 2rem', borderRadius: '12px', background: '#0f172a', color: 'white', fontWeight: 700, fontSize: '0.95rem' }}>
          Back to Login
        </Link>
      </div>
    </div>
    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{ textAlign: 'center', marginTop: '1.5rem', fontSize: '0.875rem', color: '#64748b' }}>
          ...
          <Link href="/login" style={{ color: '#0009fa', fontWeight: 700 }}>Sign in</Link>
        </p>
      </div>
